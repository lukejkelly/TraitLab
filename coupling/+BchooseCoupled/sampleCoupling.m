function [newage_x, newage_y, logq_x, logq_y] = sampleCoupling(i, j_x, j_y, ...
    ...
    elseif s_x(j_x).type == ROOT
        ...
        [new_minage_y, kT_y, logq_y] = BchooseCoupled.sampleCoupling.getUniformParameters(...
            i, j_y, k_y, s_y, THETA);
        jT_x = s_x(j_x).time;
    ...
    elseif s_y(j_y).type == ROOT
        ...
        [new_minage_x, kT_x, logq_x] = BchooseCoupled.sampleCoupling.getUniformParameters(...
            i, j_x, k_x, s_x, THETA);
        jT_y = s_y(j_y).time;
        ...
        [new_minage_x, kT_x, logq_x] ...
            = BchooseCoupled.sampleCoupling.getUniformParameters(i, ...
                j_x, k_x, s_x, THETA);
